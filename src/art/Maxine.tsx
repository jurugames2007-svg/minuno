...
function palette(skin: SkinId): Pal {
  ...
  if (skin === "huggy") return { main: "#ff4da6", light: "#ff7acc", dark: "#d92a6a", darkR: "#a81a50", cream: "#fff0f8", creamSh: "#ffd0ec", earIn: "#ff2a8a", outline: "#b02a6a", nose: "#ff8fb6" };
  ...
  if (skin === "darth") return { main: "#0a0a0a", light: "#1a1a2e", dark: "#000000", darkR: "#000000", cream: "#b0b0b0", creamSh: "#808080", earIn: "#1a0e08", outline: "#000000", nose: "#ff8fa0" };
    ...
    <svg viewBox="0 0 100 100" width={size} height={size} className={`${className} ${bodyBob ? "bob" : ""}`} style={{ overflow: "visible", filter: hurt ? "drop-shadow(0 0 6px #ff5a5a)" : undefined }}>
      ...
      <g transform={dead ? "rotate(-18 50 72) translate(0 6)" : ""}>
        ...
        <g>
          ...
          {skin === "huggy" && <g><path d="M26 34 Q14 38 16 50 Q22 48 26 40 Z" fill="#ff4da6" stroke="#b02a66" strokeWidth="0.8"/><path d="M74 34 Q86 38 84 50 Q78 48 74 40 Z" fill="#ff4da6" stroke="#b02a66" strokeWidth="0.8"/><path d="M36 30 Q50 34 64 30" fill="none" stroke="#fff" strokeWidth="1.2"/><circle cx="50" cy="16" r="2.2" fill="#ffd27a" stroke="#b02a66" strokeWidth="0.6"/><rect x="42" y="56" width="16" height="4" rx="2" fill="#fff" stroke="#b02a66" strokeWidth="0.6" opacity="0.7"/><circle cx="46" cy="58" r="1" fill="#ff8fb6"/><circle cx="54" cy="58" r="1" fill="#ff8fb6"/></g>}
          ...
          {skin === "darth" && <g><rect x="32" y="28" width="36" height="10" rx="5" fill="#0a0a0a" stroke="#1a1a2e" strokeWidth="1.2" opacity="0.95"/><path d="M32 32 Q50 8 68 32" fill="none" stroke="#1a1a2e" strokeWidth="3" opacity="0.6"/><circle cx="42" cy="40" r="3.5" fill="#ff3030" stroke="#1a0e08" strokeWidth="0.8"/><circle cx="58" cy="40" r="3.5" fill="#ff3030" stroke="#1a0e08" strokeWidth="0.8"/><path d="M44 48 Q50 44 56 48" fill="none" stroke="#ff8fa0" strokeWidth="0.8"/><rect x="38" y="54" width="24" height="4" rx="2" fill="#000" stroke="#1a1a1a" strokeWidth="0.5" opacity="0.9"/></g>}
